<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="Elearning.WebForm2" %>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="wrapper">
        <nav>
          <ul id="menu">
            ...
            <li> <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">Courses</asp:LinkButton>
               </li>
            <li><asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click">Programs</asp:LinkButton></li>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Welcome&nbsp;
      ...
      <ul class="banners">
        <li></li>
        <li></li>
        <li><asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="What Suits Me ?" BackColor="#669900" BorderColor="#000099" BorderStyle="Double" BorderWidth="5px" Font-Bold="True" Font-Italic="True" Font-Size="Medium" ForeColor="#FFFFCC" Height="72px" Width="328px" CssClass="body1" /></li>
      </ul>
    </header>
    <!-- / header -->
  </div>
      ...
      <div class="wrapper">
        <div class="pad1 pad_top1">
          <article class="cols marg_right1">
            <figure><a href="Learningform.aspx"><img src="images/page1_img1.jpg" alt=""></a></figure>
            <span class="font1">Learning Style</span> </article>
          <article class="cols marg_right1">
            <figure><a href="Personalityform.aspx"><img src="images/page1_img2.jpg" alt=""></a></figure>
            <span class="font1">Personality Factor</span> </article>
          <article class="cols">
            <figure><a href="Knowledgelevel.aspx"><img src="images/page1_img3.jpg" alt=""></a></figure>
